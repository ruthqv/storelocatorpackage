...
<div class="bh-sl-container">
    ...
    <fieldset class="bordgre">
        <legend><p class="catcol bh-sl-title custom_font_rudy textocentrado">{{ __('Store_locator') }}</p></legend>
    <div class="row">
        ...
        <form role="form" class="col-centered" id="bh-sl-user-location" method="post" action="#">
            ...
            <p class="bordbut"><button id="miposi" class="nobut"><i class="icon-location-arrow"></i> Buscar tiendas cercanas a mi ubicación actual</button></p>
    </div>
                ...
                <div class="row">
                <button id="miboton" type="button" value="Refrescar" class="nobut bh-sl-reset" /><p>RESET ALL</p></button><br>
                </div> 
                <div class="row">

                <button type="text" id="display" class="nobut"><p>LIST<span class="caret"></span></p></button>

                <button type="text" id="hide" class="nobut hide"><p>MAP<span class="caret"></span></p></button>
                </div>
                <div class="row">
                <p class="bordbut"><button type="button" class="nobut" />FILTER</button></p>
                </div>
                ...
                <p class="bordbut"><button data-toggle="collapse" data-target="#conti" class="nobut">CONTINENT<span class="caret"></span></button></p>
                ...
                <p class="bordbut"> 
                <button data-toggle="collapse" data-target="#pais" class="nobut">COUNTRY<span class="caret"></span></button></p>
