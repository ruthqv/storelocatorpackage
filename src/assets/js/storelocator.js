...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'distanceAlert'              : 60,
		'dataType'                   : 'json',
		'dataLocation'               : 'storesfiles/locations.json',
		'dataRaw'                    : null,
		'xmlElement'                 : 'marker',
		'listColor1'                 : '#ffffff',
		'listColor2'                 : '#eeeeee',
		...
		'dragSearch'                 : false,
		'infowindowTemplatePath'     : 'storesfiles/templates/infowindowdescription.html',
		'listTemplatePath'           : 'storesfiles/templates/locationlistdescription.html',
		'KMLinfowindowTemplatePath'  : 'storesfiles/templates/kmlinfowindowdescription.html',
		'KMLlistTemplatePath'        : 'storesfiles/templates/kmllocationlistdescription.html',
		'listTemplateID'             : null,
